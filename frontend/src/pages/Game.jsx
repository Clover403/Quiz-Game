...
const Game = () => {
  ...
  const { playGameMusic, stopAllMusic } = useAudio();
  ...
  }, [socket, code, navigate, isAuthenticated, user]); // Removed playGameMusic, stopAllMusic dari dependencies
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-700 to-indigo-900 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-6 border border-white/20">
          <h3 className="text-2xl font-semibold text-white mb-4">{currentQuestion.question}</h3>
          <div className="flex items-center gap-2 text-yellow-300">
            <Diamond className="w-5 h-5 fill-yellow-300" />
                ...
                className={`p-6 rounded-xl text-left transition-all duration-300 border-2 ${
                  isAnswered
                    ...
                    : isSelected
                      ...
                      : 'bg-white/10 border-white/20 backdrop-blur-lg hover:bg-white/20 hover:border-white/40'
                }`}
